            ...
            {user ? (
              ...
              <>
                ...
                <Button variant="ghost" size="icon" asChild className="text-muted hover:text-cream">
                  ...
                  <Link href={user.role === "ADMIN" ? ROUTES.admin : ROUTES.account} aria-label="Account">
        ...
        {mobileOpen && (
          ...
          <nav className="border-t border-border bg-surface px-4 py-4 lg:hidden">
            ...
            {user ? (
              ...
              <Link href={ROUTES.login} className="mt-2 block py-2 text-sm text-accent" onClick={() => setMobileOpen(false)}>
